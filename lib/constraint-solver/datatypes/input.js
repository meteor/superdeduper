...
const Input = function (dependencies, constraints, catalogCache, options) {
  var self = this;
  options = options || {};
...
const validatePackageName = function (name) {
...
Input.prototype.isKnownPackage = function (p) {
  return this.catalogCache.hasPackage(p);
};

Input.prototype.isRootDependency = function (p) {
  return _.has(this._dependencySet, p);
};

Input.prototype.isUpgrading = function (p) {
  return _.has(this._upgradeSet, p);
};

Input.prototype.isInPreviousSolution = function (p) {
...
Input.prototype.loadFromCatalog = function (catalogLoader) {
...
Input.prototype.loadOnlyPreviousSolution = function (catalogLoader) {
  var self = this;
...
Input.prototype.isEqual = function (otherInput) {
  var a = this;
  var b = otherInput;
...
Input.prototype.toJSONable = function () {
  var self = this;
  var obj = {
...
Input.fromJSONable = function (obj) {
  // _check(obj, {
  //   dependencies: [String],
  //   constraints: [String],
  //   catalogCache: Object,
  ...
  return new Input(
    ...
    CatalogCache.fromJSONable(obj.catalogCache),
    {
      upgrade: obj.upgrade,
