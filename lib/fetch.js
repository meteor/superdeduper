...
const metadataPromise = (packageJson) => new Promise((resolve) => {
  var toFetch = _.keys(packageJson.dependencies);
...
module.exports = (packageJson) => metadataPromise(packageJson);
